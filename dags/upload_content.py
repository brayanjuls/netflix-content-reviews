...
upload_generate_show_comments_job_to_gcs = FileToGoogleCloudStorageOperator(
    task_id="upload_generate_show_comments_job_to_gcs",
...
start_pipeline >> create_dataproc_cluster >> [upload_netflix_catalog_job_to_gcs, upload_reddit_comments_job_to_gcs,
                                              upload_populate_shows_table_job_to_gcs,
                                              upload_generate_show_comments_job_to_gcs] >> download_catalog_show_subdag
download_catalog_show_subdag >> [upload_netflix_catalog_job_to_gcs, upload_reddit_comments_job_to_gcs,
                                 upload_populate_shows_table_job_to_gcs,
                                 upload_generate_show_comments_job_to_gcs] >> consume_or_generate_comments >> [
    consume_show_comment_to_datalake, generate_show_comment_to_datalake]
